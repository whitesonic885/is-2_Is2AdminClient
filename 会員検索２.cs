// ADD 2007.11.13 KCL) 森本 [会員検索]フォームをコピーし、名前を[会員検索２]に変更（global対応） START
using System;
...
// MOD 2010.04.27 東都）高木 運用中のお客様のみ対象機能の追加 END
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(会員検索２));
            ...
            // lab会員タイトル
            // 
            this.lab会員タイトル.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(44)))), ((int)(((byte)(241)))), ((int)(((byte)(83)))));
            this.lab会員タイトル.Font = new System.Drawing.Font("MS UI Gothic", 16F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(128)));
            ...
            this.tex会員名.Font = new System.Drawing.Font("MS UI Gothic", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(128)));
            ...
            this.Activated += new System.EventHandler(this.会員検索２_Activated);
...
// ADD 2010.12.14 ACT）垣原 王子運送対応 START
					if (sKey[0] == "" )
					{
						...
						if (sList[0].Equals("正常終了"))
						{
							...
							{
								//王子運送会員
								s会員一覧 = sv_oji.Get_MemberTn3(gsaユーザ, sKey);
							}
							else
							{
								//福通会員
								s会員一覧 = sv_maintenance.Get_MemberTn3(gsaユーザ, sKey);
							}
						}
						else
						{
...
// MOD 2010.04.27 東都）高木 運用中のお客様のみ対象機能の追加 END
		...
		private void 会員検索２_Activated(object sender, System.EventArgs e)
		{
			if(iアクティブＦＧ == 0)
				会員一覧検索();		
		}
...
// ADD 2007.11.13 KCL) 森本 [会員検索]フォームをコピーし、名前を[会員検索２]に変更（global対応） END
