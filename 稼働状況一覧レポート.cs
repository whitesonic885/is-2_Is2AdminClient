...
namespace is2AdminClient {
    ...
    public class 稼働状況一覧レポート : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "is2AdminClient.稼働状況一覧レポート.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cached稼働状況一覧レポート : Component, ICachedReport {
        
        public Cached稼働状況一覧レポート() {
        }
